...
if TYPE_CHECKING:
    from .v1alpha2.v1alpha2_request_builder import V1alpha2RequestBuilder
...
class Model_registryRequestBuilder(BaseRequestBuilder):
    ...
    @property
    def v1alpha2(self) -> V1alpha2RequestBuilder:
        """
        The v1alpha2 property
        """
        from .v1alpha2.v1alpha2_request_builder import V1alpha2RequestBuilder

        return V1alpha2RequestBuilder(self.request_adapter, self.path_parameters)
