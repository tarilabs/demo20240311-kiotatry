...
class Model_artifactsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/model_registry/v1alpha2/model_artifacts{?nextPageToken*,orderBy*,pageSize*,sortOrder*}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[Model_artifactsRequestBuilderGetRequestConfiguration] = None) -> Optional[BaseResourceList]:
        """
    ...
    async def post(self,body: Optional[ModelArtifactCreate] = None, request_configuration: Optional[Model_artifactsRequestBuilderPostRequestConfiguration] = None) -> Optional[ModelArtifact]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[Model_artifactsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Gets a list of all `ModelArtifact` entities.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: Optional[ModelArtifactCreate] = None, request_configuration: Optional[Model_artifactsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Creates a new instance of a `ModelArtifact`.
        param body: An ML model artifact.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class Model_artifactsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[Model_artifactsRequestBuilder.Model_artifactsRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class Model_artifactsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
