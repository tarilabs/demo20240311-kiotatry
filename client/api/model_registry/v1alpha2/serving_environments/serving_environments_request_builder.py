...
class Serving_environmentsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/model_registry/v1alpha2/serving_environments{?nextPageToken*,orderBy*,pageSize*,sortOrder*}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[Serving_environmentsRequestBuilderGetRequestConfiguration] = None) -> Optional[BaseResourceList]:
        """
    ...
    async def post(self,body: Optional[ServingEnvironmentCreate] = None, request_configuration: Optional[Serving_environmentsRequestBuilderPostRequestConfiguration] = None) -> Optional[ServingEnvironment]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[Serving_environmentsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Gets a list of all `ServingEnvironment` entities.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: Optional[ServingEnvironmentCreate] = None, request_configuration: Optional[Serving_environmentsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Creates a new instance of a `ServingEnvironment`.
        param body: A Model Serving environment for serving `RegisteredModels`.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class Serving_environmentsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[Serving_environmentsRequestBuilder.Serving_environmentsRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class Serving_environmentsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
