...
class Inference_servicesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/model_registry/v1alpha2/serving_environments/{servingenvironmentId}/inference_services{?externalID*,name*,nextPageToken*,orderBy*,pageSize*,sortOrder*}", path_parameters)
    
    async def get(self,request_configuration: Optional[Inference_servicesRequestBuilderGetRequestConfiguration] = None) -> Optional[BaseResourceList]:
        """
    ...
    async def post(self,body: Optional[InferenceServiceCreate] = None, request_configuration: Optional[Inference_servicesRequestBuilderPostRequestConfiguration] = None) -> Optional[InferenceService]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[Inference_servicesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Gets a list of all `InferenceService` entities for the `ServingEnvironment`.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: Optional[InferenceServiceCreate] = None, request_configuration: Optional[Inference_servicesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Creates a new instance of a `InferenceService`.
        param body: An `InferenceService` entity in a `ServingEnvironment` represents a deployed `ModelVersion` from a `RegisteredModel` created by Model Serving.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class Inference_servicesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[Inference_servicesRequestBuilder.Inference_servicesRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class Inference_servicesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
