...
class WithServingenvironmentItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/model_registry/v1alpha2/serving_environments/{servingenvironmentId}", path_parameters)
    
    async def get(self,request_configuration: Optional[WithServingenvironmentItemRequestBuilderGetRequestConfiguration] = None) -> Optional[ServingEnvironment]:
        """
    ...
    async def patch(self,body: Optional[BaseResourceUpdate] = None, request_configuration: Optional[WithServingenvironmentItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[ServingEnvironment]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[WithServingenvironmentItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Gets the details of a single instance of a `ServingEnvironment`.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: Optional[BaseResourceUpdate] = None, request_configuration: Optional[WithServingenvironmentItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Updates an existing `ServingEnvironment`.
        param body: A Model Serving environment for serving `RegisteredModels`.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class WithServingenvironmentItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class WithServingenvironmentItemRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
