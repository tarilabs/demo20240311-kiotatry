...
class Model_artifactRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/model_registry/v1alpha2/model_artifact{?externalID*,name*,parentResourceID*}", path_parameters)
    
    async def get(self,request_configuration: Optional[Model_artifactRequestBuilderGetRequestConfiguration] = None) -> Optional[ModelArtifact]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[Model_artifactRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Gets the details of a single instance of a `ModelArtifact` that matches search parameters.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class Model_artifactRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[Model_artifactRequestBuilder.Model_artifactRequestBuilderGetQueryParameters] = None
