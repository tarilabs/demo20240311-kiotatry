...
class Serving_environmentRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/model_registry/v1alpha2/serving_environment{?externalID*,name*}", path_parameters)
    
    async def get(self,request_configuration: Optional[Serving_environmentRequestBuilderGetRequestConfiguration] = None) -> Optional[ServingEnvironment]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[Serving_environmentRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Finds a `ServingEnvironment` entity that matches query parameters.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class Serving_environmentRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[Serving_environmentRequestBuilder.Serving_environmentRequestBuilderGetQueryParameters] = None
