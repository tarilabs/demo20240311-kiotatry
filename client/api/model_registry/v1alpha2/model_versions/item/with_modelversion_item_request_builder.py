...
class WithModelversionItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/model_registry/v1alpha2/model_versions/{modelversionId}", path_parameters)
    
    async def get(self,request_configuration: Optional[WithModelversionItemRequestBuilderGetRequestConfiguration] = None) -> Optional[ModelVersion]:
        """
    ...
    async def patch(self,body: Optional[ModelVersion] = None, request_configuration: Optional[WithModelversionItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[ModelVersion]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[WithModelversionItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Gets the details of a single instance of a `ModelVersion`.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: Optional[ModelVersion] = None, request_configuration: Optional[WithModelversionItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Updates an existing `ModelVersion`.
        param body: Represents a ModelVersion belonging to a RegisteredModel.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class WithModelversionItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class WithModelversionItemRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
