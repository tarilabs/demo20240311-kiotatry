...
class Model_versionsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/model_registry/v1alpha2/model_versions{?nextPageToken*,orderBy*,pageSize*,sortOrder*}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[Model_versionsRequestBuilderGetRequestConfiguration] = None) -> Optional[BaseResourceList]:
        """
    ...
    async def post(self,body: Optional[ModelVersionCreate] = None, request_configuration: Optional[Model_versionsRequestBuilderPostRequestConfiguration] = None) -> Optional[ModelVersion]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[Model_versionsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Gets a list of all `ModelVersion` entities.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: Optional[ModelVersionCreate] = None, request_configuration: Optional[Model_versionsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Creates a new instance of a `ModelVersion`.
        param body: Represents a ModelVersion belonging to a RegisteredModel.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class Model_versionsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[Model_versionsRequestBuilder.Model_versionsRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class Model_versionsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
