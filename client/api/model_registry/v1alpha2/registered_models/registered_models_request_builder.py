...
class Registered_modelsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/model_registry/v1alpha2/registered_models{?nextPageToken*,orderBy*,pageSize*,sortOrder*}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[Registered_modelsRequestBuilderGetRequestConfiguration] = None) -> Optional[BaseResourceList]:
        """
    ...
    async def post(self,body: Optional[RegisteredModelCreate] = None, request_configuration: Optional[Registered_modelsRequestBuilderPostRequestConfiguration] = None) -> Optional[RegisteredModel]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[Registered_modelsRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Gets a list of all `RegisteredModel` entities.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: Optional[RegisteredModelCreate] = None, request_configuration: Optional[Registered_modelsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Creates a new instance of a `RegisteredModel`.
        param body: A registered model in model registry. A registered model has ModelVersion children.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class Registered_modelsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[Registered_modelsRequestBuilder.Registered_modelsRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class Registered_modelsRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
