...
class WithRegisteredmodelItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/model_registry/v1alpha2/registered_models/{registeredmodelId}", path_parameters)
    
    async def get(self,request_configuration: Optional[WithRegisteredmodelItemRequestBuilderGetRequestConfiguration] = None) -> Optional[RegisteredModel]:
        """
    ...
    async def patch(self,body: Optional[RegisteredModelUpdate] = None, request_configuration: Optional[WithRegisteredmodelItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[RegisteredModel]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[WithRegisteredmodelItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Gets the details of a single instance of a `RegisteredModel`.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: Optional[RegisteredModelUpdate] = None, request_configuration: Optional[WithRegisteredmodelItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Updates an existing `RegisteredModel`.
        param body: A registered model in model registry. A registered model has ModelVersion children.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class WithRegisteredmodelItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class WithRegisteredmodelItemRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
