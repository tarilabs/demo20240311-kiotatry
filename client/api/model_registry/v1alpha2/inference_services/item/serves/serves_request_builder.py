...
class ServesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/model_registry/v1alpha2/inference_services/{inferenceserviceId}/serves{?externalID*,name*,nextPageToken*,orderBy*,pageSize*,sortOrder*}", path_parameters)
    
    async def get(self,request_configuration: Optional[ServesRequestBuilderGetRequestConfiguration] = None) -> Optional[BaseResourceList]:
        """
    ...
    async def post(self,body: Optional[ServeModelCreate] = None, request_configuration: Optional[ServesRequestBuilderPostRequestConfiguration] = None) -> Optional[ServeModel]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[ServesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Gets a list of all `ServeModel` entities for the `InferenceService`.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: Optional[ServeModelCreate] = None, request_configuration: Optional[ServesRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        """
        Creates a new instance of a `ServeModel` associated with `InferenceService`.
        param body: An ML model serving action.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class ServesRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[ServesRequestBuilder.ServesRequestBuilderGetQueryParameters] = None

    
    from kiota_abstractions.base_request_configuration import BaseRequestConfiguration

    @dataclass
    class ServesRequestBuilderPostRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
