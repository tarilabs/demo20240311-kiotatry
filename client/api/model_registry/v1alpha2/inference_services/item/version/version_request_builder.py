...
class VersionRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/model_registry/v1alpha2/inference_services/{inferenceserviceId}/version", path_parameters)
    
    async def get(self,request_configuration: Optional[VersionRequestBuilderGetRequestConfiguration] = None) -> Optional[ModelVersion]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[VersionRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Gets the `ModelVersion` entity for the `InferenceService`.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class VersionRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
