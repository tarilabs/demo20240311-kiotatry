...
class WithInferenceserviceItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/model_registry/v1alpha2/inference_services/{inferenceserviceId}", path_parameters)
    
    async def get(self,request_configuration: Optional[WithInferenceserviceItemRequestBuilderGetRequestConfiguration] = None) -> Optional[InferenceService]:
        """
    ...
    async def patch(self,body: Optional[InferenceServiceUpdate] = None, request_configuration: Optional[WithInferenceserviceItemRequestBuilderPatchRequestConfiguration] = None) -> Optional[InferenceService]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[WithInferenceserviceItemRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Gets the details of a single instance of a `InferenceService`.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_patch_request_information(self,body: Optional[InferenceServiceUpdate] = None, request_configuration: Optional[WithInferenceserviceItemRequestBuilderPatchRequestConfiguration] = None) -> RequestInformation:
        """
        Updates an existing `InferenceService`.
        param body: An `InferenceService` entity in a `ServingEnvironment` represents a deployed `ModelVersion` from a `RegisteredModel` created by Model Serving.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class WithInferenceserviceItemRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
    ...
    @dataclass
    class WithInferenceserviceItemRequestBuilderPatchRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
