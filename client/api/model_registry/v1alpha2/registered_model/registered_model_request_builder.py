...
class Registered_modelRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/model_registry/v1alpha2/registered_model{?externalID*,name*}", path_parameters)
    
    async def get(self,request_configuration: Optional[Registered_modelRequestBuilderGetRequestConfiguration] = None) -> Optional[RegisteredModel]:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[Registered_modelRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
        """
        Gets the details of a single instance of a `RegisteredModel` that matches search parameters.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class Registered_modelRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
        ...
        query_parameters: Optional[Registered_modelRequestBuilder.Registered_modelRequestBuilderGetQueryParameters] = None
